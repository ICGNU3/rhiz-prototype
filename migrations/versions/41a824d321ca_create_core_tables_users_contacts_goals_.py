"""Create core tables: users, contacts, goals, auth_tokens, journal_entries

Revision ID: 41a824d321ca
Revises: 
Create Date: 2025-06-28 23:55:07.660733
...
def upgrade():
    ...
    # Drop tables that exist (use IF EXISTS for safety)
    try:
