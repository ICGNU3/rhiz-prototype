...
import ContactsPage from './pages/ContactsPageNew';
import IntelligencePage from './pages/IntelligencePageNew';
import TrustPage from './pages/TrustPageNew';
import CrmPage from './pages/CrmPageNew';
